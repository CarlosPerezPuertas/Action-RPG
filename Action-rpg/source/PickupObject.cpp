...
{
	std::unique_ptr<ga::Animation> anim(new ga::Animation(Entity::sprite, sf::seconds(0.2f), 0));
	
	if (type == Pickup::BigDot)
	{
		anim->addFrame(0, sf::IntRect(0, 0, 12, 12));
		anim->addFrame(0, sf::IntRect(12, 0, 12, 12));
		anim->addFrame(0, sf::IntRect(24, 0, 12, 12));
		anim->play();
	}
