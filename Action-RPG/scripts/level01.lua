...
ghost1[1]:setPosition(800, 250)
ghost1[1]:setCollisionRect(-12, 12, 20, 15)
ghost1[1]:addAnimationFrames(anim_type.go_left, "H", "Loop", 5, 0, 64, 98);
ghost1[1]:addAnimationFrames(anim_type.go_right, "H", "Loop", 5, 0, 64, 98);
ghost1[1]:addAnimationFrames(anim_type.go_up, "H", "Loop", 5, 0, 64, 98);
ghost1[1]:addAnimationFrames(anim_type.go_down, "H", "Loop", 5, 0, 64, 98);
--ghost1[1]:moveUp(50)
